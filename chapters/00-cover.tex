\begin{titlepage}
    \begin{center}
        ...
        \uppercase{SISTEM REKOMENDASI JALUR OPTIMAL UNTUK\\ TRAFFIC ENGINEERING JARINGAN LAYER 2\\ BERBASIS GRAPH ATTENTION NETWORK}
        \par}

        % --- PENGATURAN JARAK VERTIKAL ---
        % Kembalikan ke spasi 1.5 agar perhitungan '4 x 1,5 spasi' akurat
        \setstretch{1.5}
        ...
        % Kembalikan ke spasi 1.5 untuk menghitung jarak berikutnya
        \setstretch{1.5}
